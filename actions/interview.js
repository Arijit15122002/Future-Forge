...
export async function generateQuiz() {
    ...
    try {
        const prompt = `
            Generate 10 technical interview questions for a ${user.industryInsight.industry} professional ${user.skills.length ? `with expertise in ${user.skills.join(', ')}` : ''}.
    ...
    try {
        ...
        if( wrongAnswers.length > 0 ) {
            ...
            const improvementPrompt = `
                ...
                Focus on the knowledge gaps revealed by these wrong asnswers.
